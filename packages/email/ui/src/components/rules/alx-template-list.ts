...
export class AlxTemplateList extends LitElement {
  ...
  constructor() {
    super();
    this._showHelp = localStorage.getItem('alx-help-templates') === 'true';
  }

  private _toggleHelp(): void {
    this._showHelp = !this._showHelp;
    localStorage.setItem('alx-help-templates', String(this._showHelp));
  }
      ...
      <div class="alx-card">
        ...
        ${this._showHelp ? html`
          <div class="help-panel">
            <strong>Templates</strong> define email content — subject lines, body HTML, and variables.
            <ul>
              <li><strong>Active toggle</strong> — Inactive templates can't be used by rules</li>
              <li><strong>A/B Testing</strong> — Add multiple subjects/bodies to a template. One variant is randomly picked per send.</li>
              <li>Create a template first, then create a Rule to start sending it.</li>
            </ul>
          </div>
        ` : ''}
